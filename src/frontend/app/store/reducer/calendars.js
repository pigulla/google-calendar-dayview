        ...
        case Actions.LOAD: {
            return handle(state, action, {
                success(prev_state) {
                    ...
                    new_state = new_state
                        .set('last_error', null)
                        .set('updated', ZonedDateTime.parse(action.payload.updated))
                        .set('all', update_map_differential(current_map, next_map));
                ...
                failure(prev_state, current_action) {
                    return prev_state.set('last_error', current_action.payload);
                }
            });
        }
